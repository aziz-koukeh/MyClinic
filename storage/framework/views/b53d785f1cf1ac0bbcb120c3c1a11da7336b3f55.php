                        ...
                        <div class="row px-2 py-3">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="<?php echo e(route('Clinic.login')); ?> " class="user" style="direction:rtl">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="exampleInputUsername" aria-describedby="usernameHelp" placeholder="اسم المستخدم">
...
unset($__errorArgs, $__bag); ?>" id="exampleInputPassword" placeholder="كلمة المرور">
...
<?php /**PATH E:\Projects\xampp\htdocs\MyClinicApp8\resources\views/myClinic/auth/login.blade.php ENDPATH**/ ?>