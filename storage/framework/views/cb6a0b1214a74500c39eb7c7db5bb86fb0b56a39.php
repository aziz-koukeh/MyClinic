    ...
    <div>&nbsp;</div>
        ...
        <div class="card o-hidden border-left-primary border-right-primary  border-bottom-primary border-top-primary border-0 py-2" style="direction:ltr;min-height: calc(100vh - 100px)" >
            <div class="card-body p-0" >
                <form  class="user p-1" method="POST" action="<?php echo e(route('Clinic.storePatientfully')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <!-- Nested Row within Card Body -->
                    <div class="d-flex mx-2" style="direction: rtl">

                        <a href="<?php echo e(route('Clinic.newPatient')); ?>" class="btn btn-outline-primary text-xs font-weight-bold mt-1" style="width: 100px">إدخال سريع</a>
                                        ...
                                        <td style="padding: 0%">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="d-flex ">
                                                    ...
                                                    <input class="form-control <?php $__errorArgs = ['patient_name'];
...
unset($__errorArgs, $__bag); ?>" id="patientName" type="text" autofocus required  name="patient_name" style="width: 80%; padding: 0;height: auto;text-align:center">
...
unset($__errorArgs, $__bag); ?>
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group mb-2 col-2" style="direction: rtl;margin-bottom: 0.5rem;">
                                                                        ...
                                                                        <input type="tel" max="30" min="0" class="form-control form-control <?php $__errorArgs = ['child_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                        ...
                                        <td style="padding: 0%">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="d-flex ">
                                                    ...
                                                    <input class="text-xs form-control <?php $__errorArgs = ['created_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="created_at" max="<?php echo e(Carbon\Carbon::today()->format('Y-m-d')); ?>" type="date" required  name="created_at" style="width: auto; padding: 0;height: 40px;text-align:center">
...
unset($__errorArgs, $__bag); ?>
                                                    <div class="card" style="width: -webkit-fill-available">
                                                        <select name="review_type" required class="text-xs form-control <?php $__errorArgs = ['review_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" style="width: 100%; padding: 0;height: 38px;text-align:center;direction:ltr" >
                                                            <?php $__errorArgs = ['review_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                        ...
                                                        <div class="card-body px-2 py-0" style="overflow-y: auto;height: 100%;direction: ltr">
                                                            <div style="direction: rtl">
                                                                <div class="form-group mt-1 position-relative" style="direction:rtl;text-align:right;margin-bottom: 0.3rem" >
                                                                    ...
                                                                    <textarea id="main_complaint" required class=" VoiceToText form-control <?php $__errorArgs = ['main_complaint'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="main_complaint" rows="1" style="padding: 0.375rem 0.75rem;text-align:center" ></textarea>
                                                                        <?php $__errorArgs = ['main_complaint'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                                ...
                                                                <div class="form-group position-relative" style="direction:rtl;text-align:right;margin-bottom: 0.3rem" >
                                                                    ...
                                                                    <textarea id="medical_report" class="VoiceToText form-control <?php $__errorArgs = ['medical_report'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="medical_report" rows="1" style="padding: 0.375rem 0.75rem;text-align:center" ></textarea>
...
unset($__errorArgs, $__bag); ?>
                                                                ...
                                                                <div class="form-group mb-1 position-relative" style="direction:rtl;text-align:right" >
                                                                    ...
                                                                    <textarea id="treatment_plan" class="VoiceToText form-control <?php $__errorArgs = ['treatment_plan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="treatment_plan" rows="1" style="padding: 0.375rem 0.75rem;text-align:center" ></textarea>
                                                                    ...
                                                                    <div class="collapse" id="patientReviewMoreInfo">
                                                                        <div class="card-body px-1 py-1">
                                                                            <div class="form-group mb-2 position-relative" style="direction:rtl;text-align:right" >
                                                                                ...
                                                                                <textarea id="med_analysis_T" class="VoiceToText form-control <?php $__errorArgs = ['med_analysis_T'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="med_analysis_T" rows="1" style="padding: 0.375rem 0.75rem;text-align:center" ></textarea>
...
unset($__errorArgs, $__bag); ?>
                                                                            ...
                                                                            <div class="form-group mb-2 position-relative" style="direction:rtl;text-align:right" >
                                                                                ...
                                                                                <textarea id="med_photo_T" class="VoiceToText form-control <?php $__errorArgs = ['med_photo_T'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="med_photo_T" rows="1" style="padding: 0.375rem 0.75rem;text-align:center" ></textarea>
...
unset($__errorArgs, $__bag); ?>
                                                                            ...
                                                                            <div class="form-group mb-0 mb-2" style="direction:rtl;text-align:right" >
                                                                                ...
                                                                                <input type="date" min="<?php echo e(Carbon\Carbon::tomorrow()->format('Y-m-d')); ?>" class="form-control <?php $__errorArgs = ['date_expecting'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                                            ...
                                                                            <div class="form-group mb-2 position-relative" style="direction:rtl;text-align:right" >
                                                                                ...
                                                                                <textarea id="pain_story" class=" VoiceToText form-control <?php $__errorArgs = ['pain_story'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="pain_story" rows="1" style="padding: 0.375rem 0.75rem;text-align:center" ></textarea>
...
unset($__errorArgs, $__bag); ?>
                                                                            ...
                                                                            <div class="form-group mb-2 position-relative" style="direction:rtl;text-align:right" >
                                                                                ...
                                                                                <textarea id="doctor_notes" class=" VoiceToText form-control <?php $__errorArgs = ['doctor_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="doctor_notes" rows="1" style="padding: 0.375rem 0.75rem;text-align:center"></textarea>
...
<?php echo $__env->make('layouts.myClinic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\xampp\htdocs\MyClinicApp8\resources\views/myClinic/patients/newPatient1.blade.php ENDPATH**/ ?>