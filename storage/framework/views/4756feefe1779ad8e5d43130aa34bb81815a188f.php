...
<div class=" h-100 p-1 " style="direction: rtl;text-align:right ;font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">
    ...
    <div class=" pt-2 pb-4" style="display:flex">
        <a href="<?php echo e(route('Clinic.index')); ?>"  class="text-center" style="width:30%;">
            <div>
                <p class="text-xs text-gray-700 p-0 m-0">عيادة الدكتور <?php echo e($patientReview->patient->user->name); ?></p>
                <p class="text-xs text-gray-700 p-0 m-0">
                    <?php if($patientReview->patient->user->doctor_info->university): ?>
                        جامعة <?php echo e($patientReview->patient->user->doctor_info->university); ?>

                    <?php endif; ?>
                    <?php if($patientReview->patient->user->doctor_info->med_specialty): ?>
                        - <?php echo e($patientReview->patient->user->doctor_info->med_specialty); ?>

                    <?php endif; ?>
                </p>
                <p class="text-xs text-gray-700 p-0 m-0" style="direction:ltr"><?php echo e($patientReview->patient->user->mobile); ?>

                    <?php if($patientReview->patient->user->doctor_info->address): ?>
                        / <?php echo e($patientReview->patient->user->doctor_info->address); ?>
        ...
        <div  class="text-center" style="width:50%;">
            ...
            <a href="<?php echo e(route('Clinic.patientProfile',$patientReview->patient->patient_slug)); ?>">
                <p class="h5 text-gray-900 p-0 m-0">اسم المريض : <b><?php echo e($patientReview->patient->patient_name); ?></b></p>
            </a>
        </div>
        <div style="text-align: center;width: 20%;">
            ...
            <p class="text-xs text-gray-700 p-0 m-0">تاريخ الإدخال : <?php echo e($patientReview->patient->created_at->format('D d-m-Y')); ?></p>
            <p class=" text-xs text-gray-900  p-0 m-0"></p>
    ...
    <div class="table-responsive"  style="border-radius: 10px; border: 1px solid;" >
        <table class="table table-bordered mb-0">
            ...
            <tbody>
                <tr>
                    <?php if($patientReview->patient->gender): ?>
                        <td class=" text-gray-900"><?php if($patientReview->patient->gender == 'male'): ?> <?php echo e('ذكر'); ?> <?php elseif($patientReview->patient->gender == 'female'): ?> <?php echo e('أنثى'); ?> <?php endif; ?></td>
                    <?php else: ?>
                    ...
                    <?php if($patientReview->patient->age && $patientReview->patient->age!= date('Y') ): ?>
                        <td class=" text-gray-900" style="direction:rtl"><?php echo e(date('Y') - $patientReview->patient->age .' سنة'); ?></td>
                    <?php else: ?>
                        <td class=" text-gray-900" style="direction:rtl;line-height: 46px;">---------------------</td>
                    <?php endif; ?>
                    <?php if($patientReview->patient->blood_type): ?>
                        <td class=" text-gray-900" style="direction:rtl"><?php echo e($patientReview->patient->blood_type); ?></td>
                    <?php else: ?>
                        <td class=" text-gray-900" style="direction:rtl;line-height: 46px;">---------------------</td>
                    <?php endif; ?>
                    <?php if($patientReview->patient->smoking): ?>
                        <td class=" text-gray-900" style="direction:rtl"><?php if($patientReview->patient->smoking == 'negative'): ?> <?php echo e('سلبي'); ?> <?php elseif($patientReview->patient->smoking == 'positive'): ?>  <?php echo e('إيجابي'); ?> <?php endif; ?></td>
                    <?php else: ?>
                        <td class=" text-gray-900" style="direction:rtl;line-height: 46px;">---------------------</td>
                    <?php endif; ?>
                    <?php if($patientReview->patient->relationship): ?>
                        <td class=" text-gray-900" style="direction:rtl"><?php if($patientReview->patient->relationship == 'married'): ?> <?php echo e('متزوج'); ?> <?php elseif($patientReview->patient->relationship == 'single'): ?>  <?php echo e('أعزب'); ?> <?php endif; ?></td>
                    <?php else: ?>
                        <td class=" text-gray-900" style="direction:rtl;line-height: 46px;">---------------------</td>
                    <?php endif; ?>
                    <?php if($patientReview->patient->child_count): ?>
                        <td class=" text-gray-900" style="direction:rtl"><?php echo e($patientReview->patient->child_count); ?></td>
                    <?php else: ?>
                        <td class=" text-gray-900" style="direction:rtl;line-height: 46px;">---------------------</td>
                    <?php endif; ?>
                </tr>
    ...
    <div class="pt-2">
        <div class="w-100 d-inline-flex px-4">
            <div class="w-100 text-center d-inline-flex" style="width: 30%;">
                ...
                <?php if($patientReview->patient->phone): ?>
                    <p class="  text-gray-900  p-0 m-0" style=" direction:ltr"><?php echo e($patientReview->patient->phone); ?></p>
                <?php else: ?>
            ...
            <div class="w-100 text-center d-inline-flex" style="width: 20%;">
                ...
                <?php if($patientReview->patient->patient_job): ?>
                    <p class="  text-gray-900  p-0 m-0" style=" direction:ltr"><?php echo e($patientReview->patient->patient_job); ?></p>
                <?php else: ?>
                    <p class="  text-gray-900  p-0 m-0" style=" direction:ltr;line-height: 46px;"> ---------------------------------</p>
                <?php endif; ?>
            </div>
            <div class="w-100 text-center d-inline-flex" style="width: 50%;">
                ...
                <?php if($patientReview->patient->patient_address): ?>
                    <p class="  text-gray-900  p-0 m-0" style=" direction:ltr;"><?php echo e($patientReview->patient->patient_address); ?></p>
                <?php else: ?>
                    <p class="  text-gray-900  p-0 m-0" style=" direction:ltr;line-height: 46px;"> ----------------------------------------</p>
                <?php endif; ?>
            </div>
    ...
    <div class="table-responsive"  style="border-radius: 10px; border: 1px solid;" >
        <table class="table table-bordered  mb-0">
            <thead>
                <tr >
                    <th  class="border-right-dark" width="20%">
                        السوابق الجراحية
                    </th >
                    <th  class="border-right-dark" width="20%">
                        السوابق المرضية
            ...
            <tbody>
                <tr style="height: 150px" >
                    <td class="border-right-dark">
                        <?php echo e($patientReview->patient->older_surgery); ?>

                    </td>
                    <td  class="border-right-dark">
                        <?php echo e($patientReview->patient->older_sicky); ?>

                    </td>
                    <td  class="border-right-dark">
                        <?php echo e($patientReview->patient->older_sensitive); ?>

                    </td>
                    <td  class="border-right-dark">
                        <?php echo e($patientReview->patient->permanent_medic); ?>

                    </td>
                    <td  class="border-right-dark">
                        <?php echo e($patientReview->patient->patient_state); ?>
    ...
    <div class="card my-2" style="border: 2px solid;">
        ...
        <div class="card-body p-1">
                ...
                <div class="card my-2 p-1 border-top-dark border-bottom-dark" >
                    ...
                    <div class="form-row">
                        <div class="col-6 mb-2">
                            <div class="card  h-100 mb-2 p-1 border-right-dark" style="border: 1px solid;">
            ...
            <div class="card mb-2 p-1 border-right-dark"  style="border: 1px solid;">
                <div class="text-md text-dark text-uppercase mb-1"><b>رأي الطبيب:</b></div>
            ...
            <div class="card mb-2 p-1 border-right-dark" >
...
<?php echo $__env->make('layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\xampp\htdocs\MyClinicApp8\resources\views/myClinic/patients/printReview.blade.php ENDPATH**/ ?>