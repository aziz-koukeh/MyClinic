                ...
                <div class="card-body p-1" style="overflow-y: auto">
                    ...
                    <div class="form-row m-0" style=";direction:rtl" >
                        ...
                        <div class="col-md-7 p-4">
                            ...
                            <?php if($doctor_info->exp_about || $doctor_info->exp_work_year): ?>
                                <div class="h6 mb-1 font-weight-bold text-gray-800">
                                    <?php if($doctor_info->exp_about): ?> - مجالات التخصص تشمل : <?php echo e($doctor_info->exp_about); ?>

                                    <?php endif; ?>
                                    <?php if($doctor_info->exp_work_year): ?>  خبرة عمل ما يقارب
                            ...
                            <?php if($doctor_info->address): ?> <div class=" mb-1 font-weight-bold text-gray-800"> - عنوان العيادة : <?php echo e($doctor_info->address); ?> .</div> <?php endif; ?>
                            ...
                            <hr>
                            <a class="small" href="<?php echo e(route('Clinic.welcome')); ?>">صفحة الدخول</a>
...
<?php /**PATH E:\Projects\xampp\htdocs\MyClinicApp8\resources\views/myClinic/about.blade.php ENDPATH**/ ?>